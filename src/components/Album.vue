...
<template>
  <div>
    ...
    <div class="lightbox fixed pin z-50 flex justify-center items-cente top-0 w-screen h-screen" v-if="visible" @click="hide">
      <div class="fixed pin-r pin-t text-white cursor-pointer text-4xl p-1 mr-2 right-0 top-0" @click.stop="hide">&times;</div>
      <div class="flex">
